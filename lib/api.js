...
module.exports = {
  order: {
    unified: function(config, data, cb) {
      ...
      request(config, url, data, validation.unified.sending, validation.unified.receiving, cb)
    },
    query: function(config, data, cb) {
      var request = require('../').request
      var url = 'https://api.mch.weixin.qq.com/pay/orderquery'
      request(config, url, data, validation.order.query, validation.order.trade, cb)
    },
  ...
  statements: function(config, data, cb) {
    ...
    request(config, url, data, validation.statements.sending, null, cb)
  },
  report: function(config, data, cb) {
    var request = require('../').request
    var url = 'https://api.mch.weixin.qq.com/payitil/report'
    request(config, url, data, validation.report.sending, null, cb)
  },
